/// STEP EVENT - o_enemy_wolf_dash_hitbox
/// ==========================================
/// Detecta colisión con el jugador y aplica daño una sola vez
/// Se mueve con el lobo durante el dash
/// ==========================================

// Si ya golpeó, solo reducir vida útil
if (has_hit) {
    lifespan--;
    if (lifespan <= 0) {
        instance_destroy();
...
if (player != noone && !has_hit) {
    ...
    show_debug_message("Lobo golpeó al jugador en dash con " + string(damage) + " de daño");
}
